import { X, Download, Printer, Calendar, User } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-200">
        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <div className="mt-4 inline-block bg-white border border-gray-200 px-4 py-2 rounded-xl">
              <span className="text-sm font-medium text-gray-700">Prescription ID: {prescription.id}</span>
            </div>
        ...
        <div className="flex justify-center gap-4 p-6 border-t border-gray-200">
          ...
          <button
            onClick={onClose}
            className="flex items-center gap-2 bg-gray-200 text-gray-700 px-6 py-3 rounded-xl hover:bg-gray-300 transition-colors border border-gray-300"
          >
            Close
          </button>
        </div>
