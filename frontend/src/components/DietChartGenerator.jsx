      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            {/* AyuChart Title */}
            <h1 className="md:text-7xl text-6xl font-bold text-black mb-6">AyuChart</h1>
            <p className="md:text-xl text-md text-gray-600 mb-8">Get personalized nutrition recommendations</p>
